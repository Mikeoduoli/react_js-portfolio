                    ...
                    <div className="p-2">
                        <div className="text-gray-300 my-3">
                            <p className="text-justify leading-7 w-11/12 mx-auto">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maiores dignissimos id nam in rem reprehenderit quis, illo dolores minus numquam molestiae enim, ullam laudantium eaque odio corporis at iusto dolorem!
                            </p>
                            ...
                            <br />
                            <br />
                            <a href="src/assets/Michael_Obed_Oduoli_DataAnalystResume.pdf" download>
